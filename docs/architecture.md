# 1. Convention documentaire sur les versions
...
# 2. Architecture actuellement implémentée
...
## 2.4. Organisation du dépôt documentée à partir de l'arborescence réelle
...
## 2.5. Artefacts locaux et données non versionnés
...
## 3.1. Chaîne fonctionnelle cible
...
## 3.2. Éléments prévus mais absents de l'arborescence actuelle
...
# 4. Feuille de route V0.1 à V0.8
